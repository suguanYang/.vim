...
map <leader>rt :!ctags --extra=+f --languages=+javascript --exclude=*.min.* --exclude=vendors --exclude=*.test.* --exclude=.git --exclude=node_modules --exclude=dist --exclude=log -R *<CR><C-M>
